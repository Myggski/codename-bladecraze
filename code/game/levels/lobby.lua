...
local function load()
  ...
  walls(level, 2, 0, vector2(3, -4))
  walls(level, 2, 0, vector2(3, -2))
  walls(level, 2, 0, vector2(3, 0))
  walls(level, 2, 0, vector2(3, 2))
  walls(level, 2, 0, vector2(3, 4))

  walls(level, 2, 0, vector2(1, -4))
  walls(level, 2, 0, vector2(1, -2))
  walls(level, 2, 0, vector2(1, 0))
  walls(level, 2, 0, vector2(1, 2))
  walls(level, 2, 0, vector2(1, 4))
  walls(level, 2, 0, vector2(5, -4))
  walls(level, 2, 0, vector2(5, -2))
  walls(level, 2, 0, vector2(5, 0))
  walls(level, 2, 0, vector2(5, 2))
  walls(level, 2, 0, vector2(5, 4))
  ...
  walls(level, 2, 0, vector2(-7, -4))
  walls(level, 2, 0, vector2(-7, -2))
  walls(level, 2, 0, vector2(-7, 0))
  walls(level, 2, 0, vector2(-7, 2))
  walls(level, 2, 0, vector2(-7, 4))
