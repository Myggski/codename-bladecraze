...
local function load()
  ...
  walls(level, 2, 0, vector2(-6, -3))
  walls(level, 2, 0, vector2(-7, -4))
  walls(level, 2, 0, vector2(-5, -3))
  walls(level, 2, 0, vector2(-4, -3))
  walls(level, 2, 0, vector2(-3, -3))
  walls(level, 2, 0, vector2(-2, -3))
  walls(level, 2, 0, vector2(-1, -3))
  walls(level, 2, 0, vector2(0, -3))
  walls(level, 2, 0, vector2(1, -3))
  walls(level, 2, 0, vector2(2, -3))
  walls(level, 2, 0, vector2(3, -3))
  walls(level, 2, 0, vector2(3, -2))
  walls(level, 2, 0, vector2(3, -1))
