...
local function load()
  ...
  walls(level, 0, vector2(5, -5))
  walls(level, 0, vector2(5, -3))
  walls(level, 0, vector2(5, -1))
  walls(level, 0, vector2(5, 1))
  walls(level, 0, vector2(5, 3))
  walls(level, 0, vector2(5, 5))

  walls(level, 1, vector2(5, -6))
  walls(level, 2, vector2(5, -4))
  walls(level, 3, vector2(5, -2))
  walls(level, 3, vector2(5, 0))
  walls(level, 2, vector2(5, 2))
  walls(level, 1, vector2(5, 4))

  walls(level, 0, vector2(3, -5))
  walls(level, 0, vector2(3, -3))
  walls(level, 0, vector2(3, -1))
  walls(level, 0, vector2(3, 1))
  walls(level, 0, vector2(3, 3))
  walls(level, 0, vector2(3, 5))

  walls(level, 3, vector2(3, -6))
  walls(level, 2, vector2(3, -4))
  walls(level, 1, vector2(3, -2))
  walls(level, 1, vector2(3, 0))
  walls(level, 2, vector2(3, 2))
  walls(level, 3, vector2(3, 4))

  walls(level, 0, vector2(1, -5))
  walls(level, 0, vector2(1, -3))
  walls(level, 0, vector2(1, -1))
  walls(level, 0, vector2(1, 1))
  walls(level, 0, vector2(1, 3))
  walls(level, 0, vector2(1, 5))

  walls(level, 3, vector2(1, -6))
  walls(level, 2, vector2(1, -4))
  walls(level, 1, vector2(1, -2))
  walls(level, 1, vector2(1, 0))
  walls(level, 2, vector2(1, 2))
  walls(level, 3, vector2(1, 4))
  ...
  walls(level, 0, vector2(-7, -5))
  walls(level, 0, vector2(-7, -3))
  walls(level, 0, vector2(-7, -1))
  walls(level, 0, vector2(-7, 1))
  walls(level, 0, vector2(-7, 3))
  walls(level, 0, vector2(-7, 5))
