...
local function load()
  ...
  walls(level, 0, vector2(5, -6))
  walls(level, 0, vector2(5, -4))
  walls(level, 3, vector2(5, -2))
  walls(level, 3, vector2(5, 0))
  walls(level, 0, vector2(5, 2))
  walls(level, 0, vector2(5, 4))
  ...
  walls(level, 0, vector2(3, -4))
  walls(level, 0, vector2(3, -2))
  walls(level, 0, vector2(3, 0))
  walls(level, 0, vector2(3, 2))
  ...
  walls(level, 0, vector2(1, -4))
  walls(level, 0, vector2(1, -2))
  walls(level, 0, vector2(1, 0))
  walls(level, 0, vector2(1, 2))
