insulate("entity_query", function()
  ...
  local third_entity = entity.create(3, empty_func, empty_func)
  local fourth_entity = entity.create(4, empty_func, empty_func)
    ...
    describe("with components", function()
      describe("all", function()
        it("should only match with first_entity that has health and name component", function()
          ...
          assert.is_truthy(only_health_and_name:match(first_entity))
          assert.is_falsy(only_health_and_name:match(second_entity))
          assert.is_falsy(only_health_and_name:match(third_entity))
          assert.is_falsy(only_health_and_name:match(fourth_entity))
        end)
      end)
      ...
      describe("any", function()
        it("should match with first, second and third entity that has health or name component", function()
          ...
          assert.is_truthy(health_or_name:match(first_entity))
          assert.is_truthy(health_or_name:match(second_entity))
          assert.is_truthy(health_or_name:match(third_entity))
          assert.is_falsy(health_or_name:match(fourth_entity))
        end)
      end)
      ...
      describe("none", function()
        it("should match with first and second entity that does not have position component", function()
          ...
          assert.is_truthy(not_position:match(first_entity))
          assert.is_truthy(not_position:match(second_entity))
          assert.is_falsy(not_position:match(third_entity))
          assert.is_falsy(not_position:match(fourth_entity))
        end)
      end)

      describe("and with filters", function()
        describe("all", function()
          it("should only match with wounded entites", function()
            ...
            assert.is_falsy(only_wounded:match(third_entity))
            assert.is_falsy(only_wounded:match(fourth_entity))
          end)
        end)
        ...
        describe("any", function()
          it("should match with both wounded and healthy entites", function()
            ...
            assert.is_falsy(wounded_or_healthy:match(third_entity))
            assert.is_falsy(wounded_or_healthy:match(fourth_entity))
          end)
        end)
        ...
        describe("none", function()
          it("should not match with wounded entites", function()
            ...
            assert.is_falsy(not_wounded:match(third_entity))
            assert.is_falsy(not_wounded:match(fourth_entity))
          end)
        end)
      end)
    end)
