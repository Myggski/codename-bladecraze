  ...
  describe("is_valid_archetype", function()
    describe("all", function()
      it("should only match with first_entity that has health and name component", function()
        ...
        assert.is_truthy(only_health_and_name:is_valid_archetype(first_entity.archetype))
        assert.is_falsy(only_health_and_name:is_valid_archetype(second_entity.archetype))
        assert.is_falsy(only_health_and_name:is_valid_archetype(third_entity.archetype))
        assert.is_falsy(only_health_and_name:is_valid_archetype(fourth_entity.archetype))
      end)
    end)
    ...
    describe("any", function()
      it("should match with first, second and third entity that has health or name component", function()
        ...
        assert.is_truthy(health_or_name:is_valid_archetype(first_entity.archetype))
        assert.is_truthy(health_or_name:is_valid_archetype(second_entity.archetype))
        assert.is_truthy(health_or_name:is_valid_archetype(third_entity.archetype))
        assert.is_falsy(health_or_name:is_valid_archetype(fourth_entity.archetype))
      end)
    end)
    ...
    describe("none", function()
      it("should match with first and second entity that does not have position component", function()
        ...
        assert.is_truthy(not_position:is_valid_archetype(first_entity.archetype))
        assert.is_truthy(not_position:is_valid_archetype(second_entity.archetype))
        assert.is_falsy(not_position:is_valid_archetype(third_entity.archetype))
        assert.is_falsy(not_position:is_valid_archetype(fourth_entity.archetype))
      end)
    end)
  end)

  describe("is_entity_valid", function()
    describe("all", function()
      it("should only match with wounded entites", function()
        ...
        assert.is_falsy(only_wounded:is_entity_valid(first_entity))
        assert.is_truthy(only_wounded:is_entity_valid(second_entity))
      end)
    end)
    ...
    describe("any", function()
      it("should match with both wounded and healthy entites", function()
        ...
        assert.is_truthy(wounded_or_healthy:is_entity_valid(first_entity))
        assert.is_truthy(wounded_or_healthy:is_entity_valid(second_entity))
      end)
    end)
    ...
    describe("none", function()
      it("should not match with wounded entites", function()
        ...
        assert.is_truthy(not_wounded:is_entity_valid(first_entity))
        assert.is_falsy(not_wounded:is_entity_valid(second_entity))
      end)
    end)
  end)
end)
